...
export default function Preview() {
    ...
    return (
        <div className="p-4 whitespace-pre-wrap bg-[#323339] font-discord flex gap-[16px]">
            {/** biome-ignore lint/performance/noImgElement: e */}
            <img src="https://github.com/ronykax.png" alt="avatar" className="size-[40px] rounded-full" />
