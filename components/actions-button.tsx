...
import { type BotAction, BotActions } from "@/lib/actions";
...
export default function ActionsButton({
    ...
    return (
        <>
            <Button variant="ghost" disabled={templateId === "new"} onClick={() => setSheetOpen(true)}>
                <PickaxeIcon />
                Actions
            </Button>
            <Sheet open={sheetOpen} onOpenChange={setSheetOpen}>
                <SheetContent side="left">
                    <SheetHeader>
                        ...
                        <SheetDescription>
                            Create actions and use them to power buttons or select menus in your messages.
                        </SheetDescription>
                    </SheetHeader>
                    <div className="px-4 flex flex-col gap-4">
                        ...
                        <DataTable
                            columns={[
                                {
                                    accessorKey: "name",
                                    header: () => <div className="p-2 text-muted-foreground">Name</div>,
                                    cell: ({ row }) => (
                        ...
                        <Dialog>
                            ...
                            <DialogContent>
                                <DialogHeader>
                                    ...
                                    <DialogDescription>Create a new action for this message.</DialogDescription>
                                </DialogHeader>
                                ...
                                <DialogFooter>
                                    ...
                                    <DialogClose asChild>
                                        <Button disabled={!newActionConfirmValidity} onClick={createNewTemplate}>
                                            Confirm
                                        </Button>
                                    </DialogClose>
                                </DialogFooter>
            ...
            {actionData && actionData.type === BotActions.SendToChannel && (
                <div className="flex flex-col gap-6">
                    <div className="flex flex-col gap-2">
                        ...
                        <Select onValueChange={(value) => setActionData({ ...actionData, templateId: value })}>
                            <SelectTrigger className="w-full">
