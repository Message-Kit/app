...
export default function Page() {
    ...
    const handleSendMessage = async () => {
        await sendMessageToDiscord(components, selectedChannel)
            .then(() => {
                setResult(null);
            })
            .catch((error) => {
        ...
        <ResizablePanelGroup direction="horizontal">
            <ResizablePanel defaultSize={61.5}>
                <div className="p-4 flex flex-col gap-4 h-full overflow-y-auto">
                                    ...
                                    <NewTextDisplay
                                        ...
                                        onChange={(next) => {
                                            setComponents((prev) => {
                                                ...
                                                // preserve section object identity to avoid remounting (focus loss)
                                                s.components = [
                                                    (children[0] as APITextDisplayComponent) ??
                                                        ({
                                                            type: ComponentType.TextDisplay,
                                        ...
                                        onChangeAccessory={(nextAcc, currentValue) => {
                                            setComponents((prev) => {
                                                ...
                                                if (!nextAcc) {
                                                    const textChild = (s.components?.[0] ??
                                                        {}) as APITextDisplayComponent;
                                                    arr[index] = {
                                                        type: ComponentType.TextDisplay,
                                        ...
                                        {component.components.length <= 0 ? (
                                            ...
                                            component.components.map((child, childIndex) => {
                                                if (child.type === ComponentType.TextDisplay) {
                                                        ...
                                                        <NewTextDisplay
                                                            ...
                                                            onChangeAccessory={(nextAcc, currentValue) => {
                                                                ...
                                                                setComponents((prev) => {
                                                                    ...
                                                                    children[childIndex] =
                                                                        section as APIComponentInContainer;
                                                                    (arr[index] as APIContainerComponent).components =
                                                                        children;
                                                                    return arr;
                                                                });
                                                            }}
                                                            onMoveUp={() =>
                                                                setComponents((prev) =>
                                                                    moveChildUp(prev, index, childIndex),
                                                                )
                                                            }
                                                            onMoveDown={() =>
                                                                setComponents((prev) =>
                                                                    moveChildDown(prev, index, childIndex),
                                                                )
                                                            }
                                                            onDelete={() => {
                                                                setComponents((prev) =>
                                                    ...
                                                    const textChild = (section.components?.[0] ??
                                                        {}) as APITextDisplayComponent;
                                                    return (
                                                        <NewTextDisplay
                                                            key={getKey(child)}
                                                            ...
                                                            onChange={(next) => {
                                                                setComponents((prev) => {
                                                                    ...
                                                                    if (
                                                                        inner[0] &&
                                                                        inner[0].type === ComponentType.TextDisplay
                                                                    ) {
                                                                        inner[0] = {
                                        ...
                                        onMoveUp={() => {
                                            setComponents((prev) => {
                                                ...
                                                if (prevItem.type === ComponentType.Container) {
                                                    ...
                                                    next.splice(index, 1);
                                                    const moved =
                                                        item as APIActionRowComponent<APIComponentInMessageActionRow>;
                                                    const updated = {
                                                        ...container,
                    ...
                    {/* buttons all the way at the bottom */}
